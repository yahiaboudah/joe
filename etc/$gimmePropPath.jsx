...
(function rd_GimmePropPath(thisObj)
{
	...
	rd_GimmePropPathData.strMinAE100 = {en: "This script requires Adobe After Effects CS5 or later."};
	...
	function rd_GimmePropPath_buildUI(thisObj)
	{
		...
		if (pal !== null)
		{
			...
			pal.grp.rootObj.rootObjApp.onClick = function () {rd_GimmePropPath_buildPropPath(this.parent.parent.parent);}
			pal.grp.rootObj.rootObjComp.onClick = function () {rd_GimmePropPath_buildPropPath(this.parent.parent.parent);}
			pal.grp.rootObj.rootObjLayer.onClick = function () {rd_GimmePropPath_buildPropPath(this.parent.parent.parent);}
			pal.grp.propNameRefs.propNameRefsByMatchName.onClick = function () {rd_GimmePropPath_buildPropPath(this.parent.parent.parent);}
			pal.grp.propNameRefs.propNameRefsByName.onClick = function () {rd_GimmePropPath_buildPropPath(this.parent.parent.parent);}
			pal.grp.propNameOpts.propNameRefsByIndex.onClick = function () {rd_GimmePropPath_buildPropPath(this.parent.parent.parent);}
			pal.grp.propNameOpts.propNameCompactEnglish.onClick = function () {rd_GimmePropPath_buildPropPath(this.parent.parent.parent);}
			pal.grp.scriptRefMode.scriptRefCollapse.onClick = function () {rd_GimmePropPath_buildPropPath(this.parent.parent.parent);}
			pal.grp.refMode.refModeAbs.onClick = function () {rd_GimmePropPath_buildPropPath(this.parent.parent.parent);}
			pal.grp.refMode.refModeRel.onClick = function () {rd_GimmePropPath_buildPropPath(this.parent.parent.parent);}
	...
	if (parseFloat(app.version) < 10.0)
		alert(rd_GimmePropPath_localize(rd_GimmePropPathData.strMinAE100), rd_GimmePropPathData.scriptName);
	else
	{
