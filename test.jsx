...
// app.project.getItemsWith("name", function(name){return "customName"});
...
// //@include "src/xto copy.jsx"
// xto.load("INOP/Python");

// var p = new Python();

// var res = p.call("C:/Users/bouda/Desktop/some.py", "defdef", {args: [
//     5470
// ], kwargs: {}})
